...
public class ArrayListTest {
	...
	public static void main(String[] args) {
		...
		list.add(new Integer(20)); // boxing - 기본형을 참조형인 Wrapper클래스로 변환하는 것
		list.add(35); // jdk5.0 부터는 기본자료형을 넣을 수 있게 됨
		...
		list.add(4.56f);
		list.add("java"); //=> 모든 자료형을 저장할 수 있다.
		...
		System.out.println("삭제 후 3번째 오소 : " + f);
		*/
	}
